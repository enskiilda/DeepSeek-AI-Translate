        ...
        <div className="flex flex-col md:flex-row md:gap-0 overflow-hidden">
          ...
          <div className="flex-1 min-w-0 max-w-full md:max-w-[50%] relative p-4 md:pr-8 overflow-hidden">
            <textarea
              ...
              className="w-full bg-transparent border-0 text-2xl md:text-3xl font-normal leading-relaxed placeholder:text-muted-foreground/30 focus:ring-0 focus:outline-none focus-visible:ring-0 shadow-none resize-none p-0 h-[200px] md:h-[350px] overflow-y-auto overflow-x-hidden break-words custom-scrollbar"
              spellCheck={false}
            />
            {inputText && (
              <motion.button
          ...
          <div className="flex-1 min-w-0 max-w-full md:max-w-[50%] relative p-4 md:pl-8 overflow-hidden">
            ...
            <AnimatePresence mode="wait">
              {outputText ? (
                ...
                >
                  <div className="text-2xl md:text-3xl text-foreground/90 font-normal leading-relaxed break-words overflow-wrap-anywhere">
                    {outputText}
                  </div>
                </motion.div>
              ) : (
                <div className="text-2xl md:text-3xl text-muted-foreground/20 select-none h-[200px] md:h-[350px] break-words">
                  Tłumaczenie...
                </div>
              )}
            </AnimatePresence>
