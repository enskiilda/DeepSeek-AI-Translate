    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center p-4 md:p-8 font-sans">
      ...
      <main className="w-full max-w-5xl flex-1">
        ...
        <div className="flex flex-col md:flex-row md:gap-0">
          ...
          <div className="flex-1 relative p-4 md:pr-8">
            <textarea
              value={inputText}
              ...
              className="w-full bg-transparent border-0 text-2xl md:text-3xl font-normal leading-relaxed placeholder:text-muted-foreground/30 focus:ring-0 focus:outline-none focus-visible:ring-0 shadow-none resize-none p-0 h-[200px] overflow-y-auto custom-scrollbar"
              spellCheck={false}
            />
            {inputText && (
              <motion.button
          ...
          <div className="flex-1 relative p-4 md:pl-8">
            {outputText && (
              <motion.button
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <AnimatePresence mode="wait">
              {outputText ? (
                <motion.div
                  ...
                  exit={{ opacity: 0 }}
                  className="w-full h-[200px] overflow-y-auto custom-scrollbar pr-8"
                >
                ...
                <div className="text-2xl md:text-3xl text-muted-foreground/20 select-none h-[200px]">
                  Tłumaczenie...
                </div>
              )}
            </AnimatePresence>
      ...
      <footer className="w-full max-w-5xl py-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] text-center text-xs text-muted-foreground/30">
